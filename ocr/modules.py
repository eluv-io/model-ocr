...
class TPS_SpatialTransformerNetwork(nn.Module):
    ...
    def __init__(self, device, F, I_size, I_r_size, I_channel_num=1):
        """ Based on RARE TPS
        input:
...
class Attention(nn.Module):
    ...
    def __init__(self, device, input_size, hidden_size, num_classes):
...
class AttnLabelConverter(object):
    ...
    #     return batch_text, torch.IntTensor(length)  # TODO deleted to device
